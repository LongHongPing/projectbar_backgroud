...
class SentShortMessage extends Controller{
     ...
     * 发送邮件,只需要填写接受者即可
     */
    public static function sentEmail($from,$content,$receiver)
    {
        ...
        //Recipients
        $mail->setFrom(config('email.username'), $from); //后面这个是发送时候的昵称
     ...
     * 发送的内容，发送对象
     */
    public static function sentShortMessage($content,$phoneNumbers){ //使用为static才能被其他地方调用
        try {
